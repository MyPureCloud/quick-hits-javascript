// >> START external-contacts-schema Step by step procedure on how to create and delete schema for contact and organization type in external contact.
...
prompt.start();
// OAuth input
// >> START external-contacts-schema-step-1
prompt.get(schemaInput, function (_err, result) {
    client.loginClientCredentialsGrant(CLIENT_ID, CLIENT_SECRET)
        .then(() => {
// >> END external-contacts-schema-step-1
...
// >> START external-contacts-schema-step-2
body = {
...
// >> END external-contacts-schema-step-2

// >> START external-contacts-schema-step-3
...
// >> END external-contacts-schema-step-3

// >> START external-contacts-schema-step-4
...
// >> END external-contacts-schema-step-4

// >> START external-contacts-schema-step-5
...
// >> END external-contacts-schema-step-5
// >> END external-contacts-schema
