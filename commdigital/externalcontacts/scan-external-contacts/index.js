// >> START scan-external-contacts
// Import needed built in and external libraries.
const fs = require('fs');
const csv = require('fast-csv');
const { retry } = require('@lifeomic/attempt');

// >> START scan-external-contacts-step-1
...
// >> END scan-external-contacts-step-1

// >> START scan-external-contacts-step-3
...
// >> END scan-external-contacts-step-3
...
// >> START scan-external-contacts-step-2
/*
...
// >> END scan-external-contacts-step-2

// >> START scan-external-contacts-step-10
/*
...
async function contactsScanPage(scanCursor, initialDelay) {
    ...
    try {
        ...
        // >> START scan-external-contacts-step-11
        ...
        // >> END scan-external-contacts-step-11
...
// >> END scan-external-contacts-step-10

// >> START scan-external-contacts-step-7
/*
...
async function contactsScanAll(apiRateDelay) {
    ...
    do {
        ...
        // >> START scan-external-contacts-step-8
        if (contactsPage != null) {
            ...
            // >> END scan-external-contacts-step-8

            // >> START scan-external-contacts-step-9
            ...
            // >> END scan-external-contacts-step-9
        } else {
...
// >> END scan-external-contacts-step-7

// >> START scan-external-contacts-step-6
/*
...
// >> END scan-external-contacts-step-6
//#endregion
...
(async () => {
    ...
    // >> START scan-external-contacts-step-4
    ...
    // >> END scan-external-contacts-step-4

    // >> START scan-external-contacts-step-5
    ...
    // >> END scan-external-contacts-step-5
})();
// >> END scan-external-contacts