// >> START get-user-active-conv-gc-sdk-javascript Example of simple NodeJS function (javascript) for Genesys Cloud Function to perform Genesys Cloud Platform API requests

// Import needed built in and external libraries.
const { verifyGCToken, requestGCToken, findGCUser, findActiveConversationsForGCUser } = require('./gc_sdk_utils');

// >> START get-user-active-conv-gc-sdk-javascript-step-1
var functionLocalCache_GCToken = null;
// >> END get-user-active-conv-gc-sdk-javascript-step-1

// >> START get-user-active-conv-gc-sdk-javascript-step-2
...
// >> END get-user-active-conv-gc-sdk-javascript-step-2
    ...
    try {
        ...
        // >> START get-user-active-conv-gc-sdk-javascript-step-3
        ...
        // >> END get-user-active-conv-gc-sdk-javascript-step-3
        ...
        // >> START get-user-active-conv-gc-sdk-javascript-step-4
        ...
        if (searchUserResults && searchUserResults.total === 0) {
            ...
            // >> END get-user-active-conv-gc-sdk-javascript-step-4
        }
    } catch (error) {
        // >> START get-user-active-conv-gc-sdk-javascript-step-5
        ...
        // >> END get-user-active-conv-gc-sdk-javascript-step-5
    }
};
// >> END get-user-active-conv-gc-sdk-javascript
