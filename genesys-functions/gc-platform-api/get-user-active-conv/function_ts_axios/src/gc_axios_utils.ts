...
async function findGCUser(gcRegion: string, gcToken: string | null, inputType: string, inputId: string): Promise<Record<string, unknown>> {
    // Test for undefined, null or empty string
    if (!gcRegion) {
        throw new Error('Unset GC Region');
    }
...
async function findActiveConversationsForGCUser(gcRegion: string, gcToken: string | null, userId: string, mediaType: string): Promise<Record<string, unknown>> {
    // Test for undefined, null or empty string
    if (!gcRegion) {
        throw new Error('Unset GC Region');
    }
