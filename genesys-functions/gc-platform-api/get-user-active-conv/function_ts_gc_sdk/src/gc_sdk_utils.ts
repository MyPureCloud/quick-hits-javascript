...
async function verifyGCToken(gcRegion: string, gcToken: string | null): Promise<boolean> {
...
async function requestGCToken(gcRegion: string, gcClientId: string, gcClientSecret: string): Promise<string> {
    // Test for undefined, null or empty string
    if (!gcRegion) {
        throw new Error('Unset GC Region');
    }
...
async function findGCUser(gcRegion: string, gcToken: string | null, inputType: string, inputId: string): Promise<platformClient.Models.UsersSearchResponse> {
    // Test for undefined, null or empty string
    if (!gcRegion) {
        throw new Error('Unset GC Region');
    }
...
async function findActiveConversationsForGCUser(gcRegion: string, gcToken: string | null, userId: string, mediaType: string): Promise<platformClient.Models.AnalyticsConversationQueryResponse> {
    // Test for undefined, null or empty string
    if (!gcRegion) {
        throw new Error('Unset GC Region');
    }
    ...
    try {
        ...
        let req_data: platformClient.Models.ConversationQuery;
        if (mediaType === 'ALL') {
            req_data = {
                "conversationFilters": [
                    {
...
export {
    ...
    requestGCToken,
    findGCUser,
    findActiveConversationsForGCUser
}
