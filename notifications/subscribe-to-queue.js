...
// >> START subscribe-to-queue-step-4
...
// >> END subscribe-to-queue-step-4

websocketClient.on('connectFailed', function(error) {
    console.log('Connect Error: ' + error.toString());
});

// >> START subscribe-to-queue-step-1
// Set environment
...
.then(() => {
    ...
    // >> END subscribe-to-queue-step-1

    // >> START subscribe-to-queue-step-2
    return notificationsApi.postNotificationsChannels()
})
.then(data => {
    console.log('Channel created');
    // >> END subscribe-to-queue-step-2

    // >> START subscribe-to-queue-step-3
